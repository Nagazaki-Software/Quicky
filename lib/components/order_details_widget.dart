...
/// bottom sheet complete order with details order
class OrderDetailsWidget extends StatefulWidget {
  const OrderDetailsWidget({
    super.key,
    String? taxaDeUrgencia,
    String? subtotal,
    required this.title,
    required this.img,
    required this.category,
    bool? switchUrgency,
  })  : this.taxaDeUrgencia = taxaDeUrgencia ?? '0',
        this.subtotal = subtotal ?? '0',
        this.switchUrgency = switchUrgency ?? false;

  final String taxaDeUrgencia;
  final String subtotal;
  final String? title;
  final String? img;
  final String? category;
  final bool switchUrgency;
