...
class FotosPageViewWidget extends StatefulWidget {
  const FotosPageViewWidget({
    super.key,
    this.parameter1,
    this.parameter2,
    this.parameter3,
  ...
  final DocumentReference? referenceTask;
  final DocumentReference? chat;

  @override
  State<FotosPageViewWidget> createState() => _FotosPageViewWidgetState();
}

class _FotosPageViewWidgetState extends State<FotosPageViewWidget>
    with TickerProviderStateMixin {
  late FotosPageViewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FotosPageViewModel());
