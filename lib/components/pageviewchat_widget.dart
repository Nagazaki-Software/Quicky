...
class PageviewchatWidget extends StatefulWidget {
  const PageviewchatWidget({
    super.key,
    this.parameter1,
    this.parameter2,
  });
  ...
  @override
  State<PageviewchatWidget> createState() => _PageviewchatWidgetState();
}

class _PageviewchatWidgetState extends State<PageviewchatWidget> {
  late PageviewchatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageviewchatModel());
