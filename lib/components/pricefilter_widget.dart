            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '\$${functions.formateInteiroEmDouble(_model.sliderValue!).toString()}',
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          font: GoogleFonts.readexPro(
                            fontWeight: FlutterFlowTheme.of(context)
                                .bodyMedium
              ...
              Container(
                child: FFButtonWidget(
                  onPressed: () async {
                    FFAppState().priceFilter = valueOrDefault<int>(
                      functions.formateInteiroEmDouble(_model.sliderValue!),
                      0,
                    );
                    FFAppState().update(() {});
                    Navigator.pop(context);
