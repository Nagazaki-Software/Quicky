...
class AllChatsCompWidget extends StatefulWidget {
  const AllChatsCompWidget({
    super.key,
    this.parameter2,
  });
  ...
  @override
  State<AllChatsCompWidget> createState() => _AllChatsCompWidgetState();
}

class _AllChatsCompWidgetState extends State<AllChatsCompWidget>
    with TickerProviderStateMixin {
  late AllChatsCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllChatsCompModel());
            ...
            child: StreamBuilder<List<ChatRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children:
                      List.generate(columnChatRecordList.length, (columnIndex) {
                    final columnChatRecord = columnChatRecordList[columnIndex];
                    return Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(23.0, 0.0, 23.0, 12.0),
                      child: FutureBuilder<TasksRecord>(
                        future: TasksRecord.getDocumentOnce(
                            columnChatRecord.referenceTask!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
