...
import '/components/report_this_task_widget.dart';
                                ...
                                children: [
                                  Material(
                                    ...
                                    child: Container(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final photo = taskTasksRecord.foto
                                              .map((e) => e)
                                              .toList();
                                    ...
                                    children: [
                                      Builder(
                                        builder: (context) => InkWell(
                                          ...
                                          onTap: () async {
                                            await Share.share(
                                              'Share task with your friends ${'quick://quick.com${GoRouterState.of(context).uri.toString()}'}',
                                              sharePositionOrigin:
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              Text(
                                                taskTasksRecord.locationString,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyLarge
                                                        .override(
                                                      ...
                                                      if (taskTasksRecord
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              '${dateTimeFormat("d/M/y", taskTasksRecord.data)} at ${dateTimeFormat("jm", taskTasksRecord.tempo)}',
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                                  .override(
