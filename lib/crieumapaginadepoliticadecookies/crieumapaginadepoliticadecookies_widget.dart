...
/// CRIE UMA PAGINA DE POLITICA DE COOKIES
class CrieumapaginadepoliticadecookiesWidget extends StatefulWidget {
  const CrieumapaginadepoliticadecookiesWidget({super.key});

  static String routeName = 'CRIEUMAPAGINADEPOLITICADECOOKIES';
  static String routePath = '/crieumapaginadepoliticadecookies';

  @override
  State<CrieumapaginadepoliticadecookiesWidget> createState() =>
      _CrieumapaginadepoliticadecookiesWidgetState();
}

class _CrieumapaginadepoliticadecookiesWidgetState
    extends State<CrieumapaginadepoliticadecookiesWidget> {
  late CrieumapaginadepoliticadecookiesModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CrieumapaginadepoliticadecookiesModel());
