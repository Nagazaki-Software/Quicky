...
class PaginaOqueEstaProcurandoWidget extends StatefulWidget {
  ...
  static String routeName = 'paginaOqueEstaProcurando';
  static String routePath = '/paginaOqueEstaProcurando';
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      12.0, 10.0, 0.0, 12.0),
                                  child: Text(
                                    'You can change your task mind. At Quck, there is no shortage of options.',
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
